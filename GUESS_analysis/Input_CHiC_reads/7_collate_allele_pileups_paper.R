...
setwd("~/HRJ_monocytes/AS_CHiC/WASP/mono_34reps_allReads_using_eGene_filters/phASER_out")
...
setwd("~/HRJ_monocytes/AS_CHiC/WASP/mono_34reps_allReads_using_eGene_filters/allele_counts")
...
setwd("~/HRJ_monocytes/AS_CHiC/WASP/mono_34reps_allReads_using_eGene_filters/bedpe")
