...
pdf(file = "~/Documents/analysis/paper/chic_GUESS_BASE_Zscores.pdf")
...
### Make a version for the paper supplementary
pdf(file = "~/Documents/analysis/paper/ATAC_GUESS_BASE_Zscores.pdf")
...
ci_cor(both_rna$GUESS_Zscore_RNA, both_rna$Base_Zscore_RNA, method="spearman", type = "bootstrap", 
                                 R = 1200)
### Make a version for the paper supplementary
pdf(file = "~/Documents/analysis/paper/RNA_GUESS_BASE_Zscores.pdf")
ggplot(both_rna, aes(x = `GUESS_Zscore_RNA`, y = `Base_Zscore_RNA`, col = significance)) +
  geom_point() +
  xlab("GUESS RNA Zscore of beta") +
  ylab("BaseQTL RNA Zscore of aFC") +
  geom_hline(yintercept = 1, linetype = "dashed") +
  geom_vline(xintercept = 0, linetype = "dashed") +
  ggtitle("GUESS versus BaseQTL RNA, Zscores")
dev.off()
