...
#file <- fread("~/HRJ_monocytes/AS_ATAC/BaseQTL/bed/S025NM-01.bed")
#bed <- file[1:100000, ]
#peaks <- fread("~/HRJ_monocytes/AS_ATAC/BaseQTL/snps/closest_peaks_5kb.bed")
#outdir <- "~/HRJ_monocytes/AS_ATAC/WASP/testing"
#setwd("~/HRJ_monocytes/AS_ATAC/WASP/testing")
#############################
